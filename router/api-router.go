...
func SetApiRouter(router *gin.Engine) {
	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		optionRoute.Use(middleware.RootAuth())
		{
			...
			optionRoute.PUT("/pricing-workbench", controller.UpdatePricingWorkbench)
		...
		logRoute.GET("/upstream-cost/stat", middleware.AdminAuth(), controller.GetUpstreamCostStat)
