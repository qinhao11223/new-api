...
type ChannelOtherSettings struct {
	...
	UpstreamCostMode                      string                `json:"upstream_cost_mode,omitempty"`          // auto / response_cost / billing_units
	UpstreamCostUnit                      string                `json:"upstream_cost_unit,omitempty"`          // 上游原始计费单位，例如 USD、CNY、CREDIT
	UpstreamCostRateCNY                   *float64              `json:"upstream_cost_rate_cny,omitempty"`      // 人民币/上游计费单位；仅用于管理员成本核算
	UpstreamCostPriceVersion              string                `json:"upstream_cost_price_version,omitempty"` // 人工价格版本，写入每次成本快照
...
const (
	UpstreamCostModeAuto         = "auto"
	UpstreamCostModeResponseCost = "response_cost"
	UpstreamCostModeBillingUnits = "billing_units"

	MaxUpstreamCostRateCNY      = 1_000_000
	MaxUpstreamCostUnitLength   = 32
	MaxUpstreamPriceVersionSize = 64
)
